...
/*package com.GargatheOro.Biomes;
...
public class FantasyTree extends WorldGenAbstractTree {
	...
	public FantasyTree(Block wood, Block leaves, int metaWood, int metaLeaves) {
		this(wood, leaves, metaWood, metaLeaves, 4, 3, false);
	}

	public FantasyTree(boolean p_i2028_1_, int p_i2028_2_, int p_i2028_3_, int p_i2028_4_, boolean p_i2028_5_) {
		super(p_i2028_1_);
							...
							for (int k2 = p_76484_5_ - l1; k2 <= p_76484_5_ + l1; ++k2) {
								...
								if (Math.abs(j2) != l1 || Math.abs(l2) != l1 || p_76484_2_.nextInt(2) != 0 && i3 != 0) {
									...
									if (block1.isAir(p_76484_1_, i2, k1, k2)
										...
										this.setBlockAndNotifyAdequately(p_76484_1_, i2, k1, k2, Blocks.leaves,
												this.metaLeaves);
									}
								}
							}
