...
public class BambooTree extends WorldGenAbstractTree {
	...
	public BambooTree(Block wood, Block leaves, int metaWood, int metaLeaves) {
		this(wood, leaves, metaWood, metaLeaves, 4, 3, false);
	}

	public BambooTree(boolean p_i2028_1_, int p_i2028_2_, int p_i2028_3_, int p_i2028_4_, boolean p_i2028_5_) {
		super(p_i2028_1_);
