...
public class BiomeSapling extends BlockSapling {

	public static final String[] saplings = new String[] { "Bamboo", "Fantasy" };
	private static final IIcon[] iconLength = new IIcon[saplings.length];

	public BiomeSapling() {
		float f = 0.4F;
		this.setBlockBounds(0.5F - f, 0.0F, 0.5F - f, 0.5F + f, f * 2.0F, 0.5F + f);
		this.setCreativeTab(ModTabs.tabCoreTreeBlocks);
	}
	...
	public boolean func_149880_a(World world, int x, int y, int z, int s) {
		return world.getBlock(x, y, z) == this && (world.getBlockMetadata(x, y, z) & 7) == s;
	}
